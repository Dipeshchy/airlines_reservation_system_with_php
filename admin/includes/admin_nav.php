...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="admin-topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Airlines Admin</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
               <li><a href="../index.php">HOME SITE</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Dipesh Chaudhary <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse show col-lg-2" id="admin-sidenav">
